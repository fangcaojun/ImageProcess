...
IMAGES_PATH = '/home/fangcaojun/Documents/Python/other/ImageProcess/q/'  # 图片集地址
 
IMAGES_FORMAT = ['.jpg', '.JPG','.png']  # 图片格式
 
IMAGE_SIZE_W = 392  # 每张小图片的宽
IMAGE_SIZE_H = 278  # 每张小图片的高
 
IMAGE_ROW = 1  # 图片间隔，也就是合并成一张图后，一共有几行
 
IMAGE_COLUMN = 2  # 图片间隔，也就是合并成一张图后，一共有几列
 
IMAGE_SAVE_PATH = '/home/fangcaojun/Documents/Python/other/ImageProcess/q/w/final.jpg'  # 图片转换后的地址
